...
;; Først evalueres prosedyren "+" med argumentene 4 og 2
;;      -> (+ 4 2) = 6
...
;; Her kalles prosedyren 5, som ikke er definert
...
;; Her kalles prosedyre 4, som ikke er definert, med argumentene + og 2
...
;; define gir oss mulighet å introdusere en variabel, samt tilegne en verdi eller prosedyre til variablen.
;; først evalueres prosedyre "/" med argumentene 44 og 2
;;      -> (/ 44 2) = 22
;; deretter tilegnes verdien 22 til variablen "bar"
...
;; Kommentar til positive?-prosedyren:
...
;; forrige verd, a, lagt sammen med "nåverdi", a+b. Dvs fib-iter er avhengig av å hele tiden
;; vite 2 akkumulator verdier, som initieres til F(0)=b=0 og F(1)=a=1.
;; Samtidig som man må ha en telleverdi for å vite hvor mange rekrusive kall som skal utføres/er utført.

;; For å vise hva jeg mener har jeg skrevet ut hvordan den iterative prosessen vil se ut:
;; ?(fib 7)
;; (fib-iter 1 0 7) 
;; (fib-iter 1 1 6) 
;; (fib-iter 2 1 5) 
